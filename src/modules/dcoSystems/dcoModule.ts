...
export class DCOAppModule {
  ...
  constructor(
    ...
    // appSettingsService.setValue(AppSettings.apiAuth, 'https://dcoauthapi.azurewebsites.net');
    // appSettingsService.setValue(AppSettings.apiHome, 'https://dcowebapi.azurewebsites.net');
